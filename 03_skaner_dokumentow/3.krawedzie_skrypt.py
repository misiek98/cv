...
def get_perspective(image, contours, ratio):
    ...
    warped_image = cv2.warpPerspective(
        src=image, M=M, dsize=(max_width, max_height))
    return warped_image
...
image_cnt = cv2.drawContours(
    image.copy(), [screen_contour], -1, (0, 255, 0), 3)
...
T = threshold_local(image=warped_image, block_size=11,
